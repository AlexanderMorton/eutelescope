...
namespace eutelescope {
	...
	private:
		...
		//! This is just the work horse for function computeAlignmenToMeasurementJacobian
		void computeAlignmentToMeasurementJacobian(float x, float y, float slopeXvsZ, float slopeYvsZ);

		//! This is run at the start to create all the global parameter for all sensors.
